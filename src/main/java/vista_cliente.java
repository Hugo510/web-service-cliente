...
public class vista_cliente extends javax.swing.JFrame {
    ...
    PerezMetodo_Service instancia_class = new PerezMetodo_Service();
    PerezMetodo hipo; //instancia
    /**
     * Creates new form vista_cliente
     */
    public vista_cliente() {
        initComponents();
        hipo=instancia_class.getPerezMetodoPort();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Victor Hugo Perez Trujillo");

        jLabel2.setText("Prueba Web Service con WSDL SOAP");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        ...
        double resultado=hipo.teorema(ladoA, ladoB);
